                    ...
                    {categories.map((cat, i) => {
                        ...
                        return (
                            <Link
                                ...
                                className="group relative p-8 rounded-md bg-[#0b0b12] border border-white/5 hover:border-[#d4a574]/40 hover:-translate-y-1 transition-all fade-up overflow-hidden"
                                style={{ animationDelay: `${i * 60}ms` }}
                            >
                                <div className="absolute -right-10 -top-10 w-40 h-40 rounded-full bg-[#d4a574]/5 blur-3xl group-hover:bg-[#d4a574]/10 transition-colors" />
                                <div className="relative">
                                    <Icon className="w-8 h-8 text-[#d4a574] mb-5" />
                                    ...
                                    <span className="inline-flex items-center gap-1.5 text-xs text-[#d4a574] font-semibold uppercase tracking-wider group-hover:gap-2.5 transition-all">
