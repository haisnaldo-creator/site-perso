        ...
        >
            ...
            <div className="relative w-full max-w-md">
                <div className="text-center mb-8">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#3b82f6]/10 border border-[#3b82f6]/30 mb-6">
                ...
                >
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 rounded-md bg-[#05050a] border border-white/10 text-white text-sm focus:outline-none focus:border-[#3b82f6]/50"
                    ...
                    <button
                        ...
                        type="submit"
                        disabled={submitting}
                        className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-md bg-[#60a5fa] text-black text-sm font-bold uppercase tracking-wider hover:bg-[#3b82f6] transition-colors disabled:opacity-50"
                    >
                    ...
                    <div className="pt-3 border-t border-white/5 text-center">
                        <Link
                            to="/"
                            className="text-xs text-zinc-500 hover:text-[#60a5fa]"
                        >
                            ← Retour à l'accueil
                        </Link>
                    </div>
