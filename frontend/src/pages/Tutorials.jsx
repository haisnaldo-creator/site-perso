                ...
                <div className="max-w-7xl mx-auto px-5 md:px-8 py-4 flex flex-col md:flex-row md:items-center gap-4">
                    <div className="relative flex-1 max-w-md">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 rounded-md bg-[#0b0b12] border border-white/10 text-white text-sm placeholder:text-zinc-600 focus:outline-none focus:border-[#3b82f6]/50"
                        />
                    </div>
        ...
        <button
            ...
            className={`shrink-0 px-3.5 py-2 rounded-md text-xs font-semibold uppercase tracking-wider transition-all ${
                active
                    ...
                    : "bg-[#0b0b12] text-zinc-400 border border-white/10 hover:border-[#3b82f6]/40 hover:text-white"
            }`}
        >
            {label}
        </button>
