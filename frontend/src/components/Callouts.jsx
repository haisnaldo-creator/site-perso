...
export function TipCallout({ children }) {
    return (
        <div
            ...
            className="my-4 p-4 rounded-md bg-[#3b82f6]/5 border-l-2 border-[#60a5fa] flex items-start gap-3"
        >
            <Lightbulb className="w-4 h-4 text-[#60a5fa] mt-0.5 shrink-0" />
            <div>
                <div className="text-[11px] uppercase tracking-wider font-bold text-[#60a5fa] mb-1">
                    Astuce
                </div>
                <div className="text-sm text-[#dbeafe] leading-relaxed">
                    {children}
                </div>
            </div>
        </div>
...
export function LinkCallout({ href }) {
    return (
        <a
            ...
            className="inline-flex items-center gap-2 my-4 px-4 py-2.5 rounded-md bg-[#3b82f6]/10 border border-[#3b82f6]/30 text-[#60a5fa] text-sm font-semibold hover:bg-[#3b82f6]/15 transition-colors"
        >
